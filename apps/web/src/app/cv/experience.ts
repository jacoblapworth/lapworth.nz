...
export const xero: ExperienceItem = {
  ...
  details: [
    'Scaled the design system at Xero to support over 200 designers, 1,000 engineers and 100 product teams.',
    ...
    'Redesigned advanced tables across Xero for viewing, filtering and editing, empowering customers to easily scan, compare, and interact with their wealth of financial data.',
    ...
    'Lead user research into pain-points across the product including inconsistent experiences, and issues with density and efficiency, informing design and product strategy.',
...
export const vend: ExperienceItem = {
  ...
  details: [
    ...
    'Developed product strategies for mobile expansion, identifying opportunities for new apps and features increasing engagement. (Scanner)',
