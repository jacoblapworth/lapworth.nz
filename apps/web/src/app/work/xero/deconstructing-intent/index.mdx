...
description: Using the system before breaking the rules.
date: 2021-11-25
category: xero
hideFromRelated: true
tags:
  - xero
---
...
![Card example annotated with specific intents](2.png)
...
![The example has a negative sentiment highlight across card](3.png)
![XUI uses a negative sentiment across the left of toasts and banners](4.png)
...
![The example card includes a warning message about being overdue.](5.png)
![XUI uses an icon with red text on text inputs to highlight error messages.](6.png)
...
![The example card has a red footer for the primary action](7.png)
![XUI uses red to indicate negative, or destructive actions](8.png)
...
![Card in-situ on the dashboard](9.png)
...
![The example uses 2xlarge type to create hierarchy within the card](10.png)
![XUI uses xlarge type in it’s Overview Block ](11.png)
...
![Two examples reconstructed using different interpretations of XUI](12.png)
![Other iterations that didn’t make the cut](13.png)
