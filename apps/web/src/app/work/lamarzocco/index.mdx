...
![La Marzocco Linea Micra espresso machine](linea-micra-kitchen.png)
...
Thankfully there's a community of people who have [reverse engineered the API](https://github.com/home-assistant/core/tree/dev/homeassistant/components/lamarzocco) for the machine, so I can access data like the boiler temperature and water level.
...
![La Marzocco Linea Micra widget on iPhone](widget-iPhone.png)
